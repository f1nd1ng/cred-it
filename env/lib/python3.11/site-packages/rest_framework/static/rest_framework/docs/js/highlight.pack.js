...
hljs.registerLanguage("xl", function (e) {
  var t =
      "ObjectLoader Animate Moviebackends Slides Filters Shading Materials LensFlare Mapping VLCAudioVideo StereoDecoder PointCloud NetworkAccess RemoteControl RegExp ChromaKey Snowfall NodeJS Speech Charts",
    o = {
      keyword:
